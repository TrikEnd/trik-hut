...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg bg-dark">
    ...
    <div class="container">
        ...
        <div class="row">
        <?php foreach ($nasi as $rice) : ?>
        <div class="row-md-4">
            
        <div class="card ml-5 mb-3" style="width: 18rem;">
            <img src="img/menu/<?= $rice["gambar"]; ?>" class="card-img-top" >
            <div class="card-body">
                <h5 class="card-title"><?= $rice["nama"]; ?></h5>
                <p class="card-text"><?= $rice["deskripsi"]; ?>.</p>
                <h5>RP. <?= $rice["harga"]; ?></h5>
